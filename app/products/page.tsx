...
const productSchema = {
  ...
  itemListElement: products.map((product, index) => ({
    ...
    url: `https://summer.prayoga.io/products/${product.slug}`,
  })),
};
    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow relative">
      {product.isNew && (
        <div className="absolute top-4 left-4 z-10">
          <span className="bg-coral text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg">
            NEW
          </span>
        </div>
      )}
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Premium beach and pool essentials for your perfect Canggu
              experience
            </p>
          </div>
              ...
              <div className="bg-gradient-to-r from-coral/10 to-lime/10 rounded-2xl p-8 mb-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-gray-700 max-w-2xl mx-auto">
                    Authentic Balinese experiences to make your party truly
          ...
          <section id="pool-day-gear">
            <h2 className="font-display font-bold text-3xl mb-8 text-coral">
              Pool Day Gear
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="mt-16 bg-gradient-to-r from-teal/10 to-coral/10 rounded-2xl p-8 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6 max-w-3xl mx-auto">
              Our Balinese Arak offers you a taste of authentic local culture.
              This traditional rice wine is perfect for special celebrations and
              cultural experiences. Must be 21+ and consumed responsibly.
            </p>

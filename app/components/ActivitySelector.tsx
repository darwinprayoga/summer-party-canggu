      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          <h2 className="font-display font-bold text-3xl md:text-4xl mb-4">
            What would you like to do today in Bali?
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Tell us your vibe and we'll recommend the perfect spots with our
            premium equipment
          </p>
        </div>
          ...
          {activities.map((activity) => (
            ...
            >
              <div className="flex items-center mb-3">
                <span className="text-xl md:text-3xl mr-3">
                  {activity.emoji}
                </span>
                <h3 className="font-display font-semibold text-base md:text-lg text-charcoal group-hover:text-teal transition-colors">
                  {activity.name}
                </h3>
              </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Choose your ideal location and time
                      </p>
                    </div>
                  </div>
                  <button
              ...
              <div className="p-6">
                {recommendations.length > 0 ? (
                  <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                    {recommendations.map((location: any) => (
                      <div
                        key={location.slug}
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 mb-6">
                      We're working on curating the best spots for{" "}
                      {selectedActivityData.name.toLowerCase()}. Contact us for
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <div className="bg-gradient-to-r from-teal/10 to-coral/10 rounded-xl p-6 text-center">
                    <h4 className="font-display font-bold text-xl mb-4">
                      Need Equipment for Your Adventure?
                    </h4>
                    <p className="text-gray-600 mb-6">
                      We provide all the premium equipment you need for your{" "}
                      {selectedActivityData.name.toLowerCase()} experience
                    </p>

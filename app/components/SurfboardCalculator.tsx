...
export default function SurfboardCalculator() {
  ...
  const calculateSurfboard = () => {
    ...
    if (skillLevel === "beginner") {
      ...
      waveConditions = [
        "Small to medium waves (2-5 feet)",
        "Various break types",
        "Consistent surf spots",
      ];
      tips = [
      ...
      waveConditions = [
        "Medium to large waves (3-8+ feet)",
        "Reef breaks",
        "Powerful surf spots",
      ];
      tips = [
      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            ...
            <h2 className="font-display font-bold text-3xl md:text-4xl flex gap-2">
              Surfboard <span className="hidden md:block">Size</span> Calculator
            </h2>
          </div>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Find your perfect surfboard size based on your body measurements and
            skill level
          </p>
        </div>
                ...
                <div className="bg-mint/10 rounded-xl p-6">
                  ...
                  <div className="space-y-3 text-sm text-gray-700">
                    <div className="flex items-start">
                      ...
                      <span>
                        We calculate board volume based on your weight and skill
                        level
                      </span>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-4 h-4 text-teal mr-2 mt-0.5 flex-shrink-0" />
                      <span>
                        Board length is determined by your height and experience
                      </span>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-4 h-4 text-teal mr-2 mt-0.5 flex-shrink-0" />
                      <span>
                        Width and thickness optimize stability and performance
                      </span>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-4 h-4 text-teal mr-2 mt-0.5 flex-shrink-0" />
                      <span>
                        Recommendations include board type and wave conditions
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 p-4 bg-white rounded-lg">
                    <p className="text-xs text-gray-600">
                      <strong>Note:</strong> These calculations provide general
                      recommendations. Personal preferences, local wave
                      conditions, and specific surfing goals may require
                      adjustments. Consult with our surf experts for
                      personalized advice.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Based on your measurements and skill level
                </p>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <a
                    href={`https://wa.me/6285190459091?text=Hi! I used your surfboard calculator and I'm interested in renting a ${
                      recommendation?.boardType
                    } (${recommendation?.length} x ${recommendation?.width} x ${
                      recommendation?.thickness
                    }) for my ${recommendation?.skillLevel.toLowerCase()} level surfing in Canggu`}
                    target="_blank"
        ...
        <div className="mt-12 text-center">
          <div className="bg-white rounded-xl p-6 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-4">
              Our local surf experts in Canggu can help you choose the perfect
              board and provide lessons to match your skill level.
            </p>
            <a
